...
class AccountRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            'bday' => date("d-m-y", strtotime(str_replace('/', '-', $this->bday))),
            'issue' => date("d-m-y", strtotime(str_replace('/', '-', $this->issue))),
            'expiry' => date("d-m-y", strtotime(str_replace('/', '-', $this->expiry))),
    ...
    public function rules()
    {
        return [
            ...
            'bday' => 'required|date|date_format:d-m-y',
            'married_status' => 'in:married,single',
            'phone' => 'required|min:8|max:12',
            'passport' => 'required|min:2|max:127',
            'issue' => 'required|date|date_format:d-m-y',
            'expiry' => 'required|date|date_format:d-m-y|after:date_of_issue',
            ...
            'work_name' => 'required|min:2|max:127',
