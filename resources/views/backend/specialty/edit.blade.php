                    ...
                    <div class="kt-grid__item">
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper">
                            ...
                            <form class="kt-form" id="kt_form" method="post"
                                  action="{{ action('Backend\MessageController@update', $message->id)}}">
                                @csrf
                                ...
                                <div id="kt-wizard_general" class="kt-wizard-v3__content"
                                    ...
                                    <div class="kt-form__section kt-form__section--first">
                                        <div class="kt-wizard-v3__form">
                                            ...
                                            <div class="form-group row">
                                                <label for="key" class="col-lg-3 col-form-label">{{__('messages.key')}}
                                                    *</label>
                                                <div class="col-lg-9">
                                                    <input id="key" type="text" name="key"
                                                           class="form-control" value="{{$message->key}}">
                                            ...
                                            <div class="form-group row">
                                                <label for="value"
                                                       class="col-lg-3 col-form-label">{{__('messages.subject')}}
                                                    *</label>
                                                <div class="col-lg-9">
                                                    <textarea id="value" name="value"
                                                              class="form-control">{{$message->value}}</textarea>
                                                </div>
