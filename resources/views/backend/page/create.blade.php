                    ...
                    <div class="kt-grid__item">
                        ...
                        <div class="kt-portlet__head kt-portlet__head--lg">
                            <div class="kt-portlet__head-label title__head">
                                <h3 class="kt-portlet__head-title ">
                                   ...
                                   {{__('messages.add')}} {{__('messages.new_message')}}&nbsp;
                                       </span>
                                </h3>
                                <span class="kt-portlet__head-icon">
                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper">
                            ...
                            <form class="kt-form" id="kt_form" method="post" enctype="multipart/form-data"
                                  action="{{ action('Backend\MessageController@store')}}">
                            @csrf
                                ...
                                <div id="kt-wizard_general" class="kt-wizard-v3__content"
                                    ...
                                    <div class="kt-form__section kt-form__section--first">
                                        <div class="kt-wizard-v3__form">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input id="key" type="text" name="key"
                                                           class="form-control" value="{{old('key')}}">
                                            ...
                                            <div class="form-group row">
                                                <label for="value"
                                                       class="col-lg-3 col-form-label">{{__('messages.subject')}}*</label>
                                                <div class="col-lg-9">
